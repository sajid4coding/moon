...
<head>
    ...
    <!-- Datatable -->
    <link href="{{ asset('dashboard_asset') }}/vendor/datatables/css/jquery.dataTables.min.css" rel="stylesheet">
								...
								<ul class="contacts">
									...
									<li class="active dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{asset('dashboard_asset') }}/images/avatar/1.jpg" class="rounded-circle user_img" alt=""/>
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{asset('dashboard_asset') }}/images/avatar/3.jpg" class="rounded-circle user_img" alt=""/>
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{asset('dashboard_asset') }}/images/avatar/4.jpg" class="rounded-circle user_img" alt=""/>
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{asset('dashboard_asset') }}/images/avatar/5.jpg" class="rounded-circle user_img" alt=""/>
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
							...
							<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="{{asset('dashboard_asset') }}/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt=""/>
									</div>
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
								<img src="{{asset('dashboard_asset') }}/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt=""/>
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
											...
											<li>
												<div class="timeline-panel">
													<div class="media mr-2">
														<img alt="image" width="50" src="{{asset('dashboard_asset') }}/images/avatar/1.jpg">
													</div>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    @if (auth()->user()->profile_image)
                                        <img src="{{ asset('uploads/profile_image')}}/{{ auth()->user()->profile_image }}" width="20" alt="Not Found">
                                    @else
                                        {{-- <img src="{{ asset('dashboard_asset')}}/images/profile_picture.png" width="20" alt=""/> --}}
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a href="{{ url('/') }}" class="ai-icon" target="_blank">
                    ...
                    {{-- <li><a href="{{ route('category.index') }}" class="ai-icon">
							<i class="flaticon-381-networking"></i>
                    ...
                    @if (auth()->user()->role == 'Admin')
						<li><a href="{{ route('product.index') }}" class="ai-icon" aria-expanded="false">
					...
					@if (auth()->user()->role == 'Vendor')
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{ route('attributes.create') }}">Attributes</a></li>
                            <li><a href="{{ route('coupon.create') }}">Coupon</a></li>
				...
				<div class="copyright">
					<p><strong>Moon eCommerce Website</strong> © {{ \Carbon\Carbon::now()->format('Y') }} All Rights Reserved</p>
