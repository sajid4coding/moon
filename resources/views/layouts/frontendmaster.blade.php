                ...
                <div class="container">
                    <div class="row align-items-center">
                            ...
                            <ul class="header_select_options ul_li">
                                <li>
                                    <div class="select_option">
                                        {{-- <div class="flug_wrap">
                                            <img src="{{ asset('frontend_asset') }}/images/flug/flug_uk.png" alt="image_not_found">
                                        </div> --}}
                                        <select class="form-select form-select-sm">
                                            <option data-display="Select Option" selected>Select Your Language</option>
                        ...
                        <div class="col col-md-6">
                            ...
                            @guest
                                <a href="{{ route('vendor_register') }}" class="header_hotline text-white">Vendor Registation</a>
                            @endguest
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col col-lg-6 col-md-6 col-sm-12">
                            <form action="#">
                                <div class="advance_serach">
                                    <div class="select_option mb-0 clearfix p-1">
                                        <select class="form-select form-select-sm">
                               ...
                               <ul class="header_icons_group ul_li_right">
                                    ...
                                    <li>
                                        <span class="cart_icon">
                                            ...
                                            {{-- <a class="text-dark" href="{{ route('cart') }}"><i class="icon icon-ShoppingCart"></i></a> --}}
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-md-3">
                            <ul class="header_icons_group ul_li_right">
                                ...
                                @guest
                                    <li>
                                        <a href="{{ route('customer_register') }}">Login | Register</a>
                                    </li>
                                @endguest
