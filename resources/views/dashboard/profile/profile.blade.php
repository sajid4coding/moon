            ...
            <div class="profile-head">
                <div class="photo-content">
                    @if (auth()->user()->cover_image)
                        <div class="cover-photo" style=" background: url({{ asset('uploads/cover_image')}}/{{ auth()->user()->cover_image}}); background-size: cover; background-position: center; min-height: 250px; width: 100%; }"></div>
                    @else
                        <div class="cover-photo" style=" background: url({{ asset('dashboard_asset')}}/images/profile/cover.jpg); background-size: cover; background-position: center; min-height: 250px; width: 100%; }"></div>
                    @endif
                </div>
                <div class="profile-info">
                    <div class="profile-photo">
                        @if (auth()->user()->profile_image)
                            <img src="{{ asset('uploads/profile_image')}}/{{ auth()->user()->profile_image }}" class="img-fluid rounded-circle" alt="">
                        @else
                            {{-- <img src="{{ asset('dashboard_asset')}}/images/profile_picture.png" class="img-fluid rounded-circle" alt=""> --}}
                    ...
                    <div class="row justify-content-center">
                        <div class="input-group mb-3 col-10">
                            <div class="custom-file">
                                <input id="profile_image" type="file" class="custom-file-input @error ('profile_image') is-invalid @enderror" name="profile_image">
                                <label class="custom-file-label">Choose file (Photo Image)</label>
                            </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="input-group mb-3 col-10">
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label">Choose file (Cover Image)</label>
                            </div>
                            <div class="input-group col-12">
                                @error('cover_image')
                                    <small class="text-danger">{{ $message }}</small>
    ...
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                @if (session('verificaton_success'))
                    <div class="alert alert-primary">
                        {{ session('verificaton_success') }}
                    </div>
                @endif
                @if (session('code_unsuccessful'))
                    <div class="alert alert-danger">
                        {{ session('code_unsuccessful') }}
                    </div>
                @endif
                @if ($errors->any())
                    <div class="alert alert-danger">
                ...
                @endif
                    <div class="mb-3">
                      <input readonly type="tel" class="form-control mb-3" name="phone_number" value="{{ auth()->user()->number }}">
                    ...
                    @if (!$Verification_status == True)
                        <a href="{{ url('phone/verification') }}" class="btn btn-primary btn-sm">Send Code</a>
                    @endif
                ...
                @if(session('code_success'))
                    <form action="{{ url('check/code') }}" method="POST">
                        @csrf
                        <div class="mt-5 mb-3">
                          <input type="text" class="form-control" name="code" placeholder="Put Your Code Here">
                        </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="profile-blog mb-5">
                    ...
                    <img src="{{ asset('dashboard_asset') }}/images/profile/1.jpg" alt="" class="img-fluid mt-4 mb-4 w-100">
                ...
                <div class="profile-interest mb-5">
                    ...
                    <div class="row mt-4 sp4" id="lightgallery">
                        <a href="images/profile/2.jpg" data-exthumbimage="images/profile/2.jpg" data-src="{{ asset('dashboard_asset') }}/images/profile/2.jpg" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                            <img src="{{ asset('dashboard_asset') }}/images/profile/2.jpg" alt="" class="img-fluid">
                        </a>
                        <a href="images/profile/3.jpg" data-exthumbimage="images/profile/3.jpg" data-src="{{ asset('dashboard_asset') }}/images/profile/3.jpg" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                            <img src="{{ asset('dashboard_asset') }}/images/profile/3.jpg" alt="" class="img-fluid">
                        </a>
                        <a href="images/profile/4.jpg" data-exthumbimage="images/profile/4.jpg" data-src="{{ asset('dashboard_asset') }}/images/profile/4.jpg" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                            <img src="{{ asset('dashboard_asset') }}/images/profile/4.jpg" alt="" class="img-fluid">
                        </a>
                        <a href="images/profile/3.jpg" data-exthumbimage="images/profile/3.jpg" data-src="{{ asset('dashboard_asset') }}/images/profile/3.jpg" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                            <img src="{{ asset('dashboard_asset') }}/images/profile/3.jpg" alt="" class="img-fluid">
                        </a>
                ...
                <div class="profile-news">
                    ...
                    <div class="media pt-3 pb-3">
                        <img src="{{ asset('dashboard_asset') }}/images/profile/5.jpg" alt="image" class="mr-3 rounded" width="75">
                    ...
                    <div class="media pt-3 pb-3">
                        <img src="{{ asset('dashboard_asset') }}/images/profile/6.jpg" alt="image" class="mr-3 rounded" width="75">
                        <div class="media-body">
                            <h5 class="m-b-5"><a href="post-details.html" class="text-black">Collection of textile samples</a></h5>
                            <p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
                        </div>
                    ...
                    <div class="media pt-3 pb-3">
                        <img src="{{ asset('dashboard_asset') }}/images/profile/7.jpg" alt="image" class="mr-3 rounded" width="75">
                        <div class="media-body">
                            <h5 class="m-b-5"><a href="post-details.html" class="text-black">Collection of textile samples</a></h5>
                            <p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
                        </div>
                            ...
                            <div id="my-posts" class="tab-pane fade active show">
                                <div class="my-post-content pt-3">
                                    ...
                                    <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                        <img src="{{ asset('dashboard_asset') }}/images/profile/8.jpg" alt="" class="img-fluid">
                                    ...
                                    <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                        <img src="{{ asset('dashboard_asset') }}/images/profile/9.jpg" alt="" class="img-fluid">
                                        <a class="post-title" href="post-details.html"><h3 class="text-black">Collection of textile samples lay spread</h3></a>
                                        <p>A wonderful serenity has take possession of my entire soul like these sweet morning of spare which enjoy whole heart.A wonderful serenity has take possession of my entire soul like these sweet morning
                                            of spare which enjoy whole heart.</p>
                                        <button class="btn btn-primary mr-2"><span class="mr-2"><i
